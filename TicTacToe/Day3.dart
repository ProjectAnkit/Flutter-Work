          ...
          Expanded(child: Container(
            child: Column(
              children: [
                ...
                Center(child: Text("Scoreboard",style: GoogleFonts.jost(color: Colors.white,fontSize: 30),),),
                Center(
                  child: Row(
                    ...
                    children: [
                     Padding(
                       ...
                       child: Column(
                        children: [
                          Text("Player O",style: GoogleFonts.jost(color: Colors.white,fontSize: 30),),
                          Text(Oscore.toString(),style: GoogleFonts.jost(color: Colors.white,fontSize: 30),)
                        ],
                       ),
                     ),
                      Padding(
                        ...
                        child: Column(
                        children: [
                          Text("Player X",style: GoogleFonts.jost(color: Colors.white,fontSize: 30),),
                          Text(Xscore.toString(),style: GoogleFonts.jost(color: Colors.white,fontSize: 30),)
                        ],
                     ),
                      )
                    ],
